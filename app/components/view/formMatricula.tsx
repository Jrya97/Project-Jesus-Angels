...
export default function FormMatricula() {
  const { formMatricula, handleChange, handleSubmit,alumno, grado } = useFormMatricula();
      ...
      <div>
        ...
        <div className="relative">
          ...
          >
            ...
            {grado.map((a) => (
              <option key={a.id_grado} value={a.id_grado}>
                {a.nombre} - {a.nivel}
              </option>
            ))}
          </select>
